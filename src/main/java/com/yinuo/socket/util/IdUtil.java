 ...
 */
public class IdUtil {
    static final Logger LOGGER = LoggerFactory.getLogger(IdUtil.class);
    ...
    /**
     * 目前的id都是整型的,但为了客户端不尚失精度,在客户端都使用STRING,到了服务器再转成LONG
     *
     * @param idStr
     * @return
     */
    public static Long toId(String idStr) {
        try {
            return Long.parseLong(idStr);
        } catch (NumberFormatException e) {
            LOGGER.info("invalid long number");
            return null;
        }
    }
