...
public abstract class BaseClient {
    ...
    public String get(String url) throws IOException, InvalidHttpResponseStatusException {
    ...
    public String post(String url) throws IOException, InvalidHttpResponseStatusException {
    ...
    private String service(HttpRequestBase request) throws IOException, InvalidHttpResponseStatusException {
        ...
        try {
            ...
            if (statusCode == 200 || statusCode == 201) {
                ...
                throw new InvalidHttpResponseStatusException(statusCode);
            }
        } finally {
            if (request != null) {
